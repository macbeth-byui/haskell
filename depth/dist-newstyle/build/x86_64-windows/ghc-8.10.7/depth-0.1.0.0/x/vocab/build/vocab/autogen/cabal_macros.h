...
/* package depth-0.1.0.0 */
#ifndef VERSION_depth
#define VERSION_depth "0.1.0.0"
#endif /* VERSION_depth */
#ifndef MIN_VERSION_depth
#define MIN_VERSION_depth(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_depth */
...
#define CURRENT_COMPONENT_ID "depth-0.1.0.0-inplace-vocab"
